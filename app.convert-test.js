...
async function onSubmitIncident() {
  ...
  const checkpointPayload = {
    ...
    gps_lng: state.gps.lng,
    photo_url: state.checkpointPhoto,
    remark: hasAbnormal ? `[มี๬ห�"ุ] ${detail}` : "à¹„à¸¡à¹ˆà¸¡à¸µà¹€à¸«à¸•à¸¸à¸œà¸´à¸”à¸›à¸à¸•à¸´"
  };
...
function updateActionCardsState() {
  ...
  setText(el.qrStepStatus, hasQr ? "สแก�"แล�0ว" : "à¸¢à¸±à¸‡à¹„à¸¡à¹ˆà¸ªà¹à¸à¸™");
  setText(el.gpsStepStatus, hasPhoto ? "à¸–à¹ˆà¸²à¸¢à¹à¸¥à¹‰à¸§" : "à¸¢à¸±à¸‡à¹„à¸¡à¹ˆà¸–à¹ˆà¸²à¸¢");
  setText(el.incidentStepStatus, hasQr && hasGps && hasPhoto ? "�~ร�0อมยื�"ยั�"" : "à¸£à¸­à¸‚à¹‰à¸­à¸¡à¸¹à¸¥à¹ƒà¸«à¹‰à¸„à¸£à¸š");
}
